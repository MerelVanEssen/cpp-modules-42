...
/*   Updated: 2024/05/09 11:59:34 by mvan-ess         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	std::cout << "In command, compile error because of the abstract AAnimal class" << std::endl;
	{
		// const AAnimal	animal;
	}
	std::cout << std::endl << "New and delete (reverse order)" << std::endl;
	{
